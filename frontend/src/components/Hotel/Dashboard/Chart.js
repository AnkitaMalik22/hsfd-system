...
import { foodsOfThisMonth } from "../../../actions/foodAction.js";
...
export default function Chart() {
  ...
  const { foodDetails, loading, error } = useSelector(
    (state) => state.foodsPerMonth
  );
  ...
  foodDetails &&
    foodDetails.forEach((food) => {
      data.push(createData(`${food.month}/${food.year}`, food.day));
    });
